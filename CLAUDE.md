...
AlgorithmMode::Auto → should_use_perturbation()?
  ...
  - Zoom extreme (pixel_size < 1e-15)   → force GMP
  - sinon: f64 standard
...
| `multibrot_power` | puissance z^d + c | 2.0 |
...
| 5-12 | JuliaSin, Newton, Phoenix, Buffalo, Barnsley, Magnet | f64/GMP |
| 13 | Burning Ship | escape-time + perturbation |
| 14-15 | Tricorn, Mandelbulb | f64/GMP |
| 16 | Buddhabrot | special |
| 17 | Lyapunov | special (presets) |
| 18-23 | PerpendicularBS, Celtic, Alpha, Pickover, Nova, Multibrot | f64/GMP |
