...
- **Date** : 2026-07-03T19:55:07+00:00
- **Commit** : `f4020a6`  ⚠️ arbre modifié (dirty)
...
|---|---:|---|
| geomean ratio | 0.879 |  (↓0.0101 ✅) |
| pire ratio | 5.422 (glitch_test_2) | |
| wins (ratio<1) | 4 | |
| timeouts | 0 | |
| cas comparés | 10/10 | |
...
| 6 | 3 vitesse | speed | `glitch_test_2` | ratio | 5.4218 | 5.42× plus lent que F3 |
| 7 | 3 vitesse | speed | `dragon` | ratio | 3.1509 | 3.15× plus lent que F3 |
